...
# of create_status_dict and the input of render_standalone_status_page).
KipStatusEntry = dict[
    str,
...
def render_standalone_status_page(
    kip_status: list[KipStatusEntry],
    output_filename: str,
