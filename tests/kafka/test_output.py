...
class TestCreateVoteDictCrossTypeDedup:
    ...
    def test_voter_changes_vote_keeps_latest_only(self):
        ...
        mentions = _make_mentions([
            {"kip": 1, "from": "Luke Chen", "vote": "0", "timestamp": "2025-01-01 10:00"},
            {"kip": 1, "from": "Luke Chen", "vote": "+1", "timestamp": "2025-01-02 10:00"},
        ])
    ...
    def test_voter_changes_vote_from_plus_to_minus(self):
        ...
        mentions = _make_mentions([
            {"kip": 2, "from": "Alice", "vote": "+1", "timestamp": "2025-03-01 08:00"},
            {"kip": 2, "from": "Alice", "vote": "-1", "timestamp": "2025-03-02 08:00"},
        ])
        result = create_vote_dict(mentions)
    ...
    def test_multiple_voters_different_votes(self):
        ...
        mentions = _make_mentions([
            {"kip": 3, "from": "Alice", "vote": "+1", "timestamp": "2025-01-01 10:00"},
            {"kip": 3, "from": "Bob", "vote": "-1", "timestamp": "2025-01-01 11:00"},
            {"kip": 3, "from": "Charlie", "vote": "0", "timestamp": "2025-01-01 12:00"},
        ])
        result = create_vote_dict(mentions)
    ...
    def test_duplicate_same_vote_type_keeps_latest(self):
        ...
        mentions = _make_mentions([
            {"kip": 4, "from": "Alice", "vote": "+1", "timestamp": "2025-01-01 10:00"},
            {"kip": 4, "from": "Alice", "vote": "+1", "timestamp": "2025-01-05 10:00"},
        ])
        result = create_vote_dict(mentions)
    ...
    def test_voters_sorted_by_timestamp_descending(self):
        ...
        mentions = _make_mentions([
            {"kip": 5, "from": "Alice", "vote": "+1", "timestamp": "2025-01-01 10:00"},
            {"kip": 5, "from": "Bob", "vote": "+1", "timestamp": "2025-01-03 10:00"},
            {"kip": 5, "from": "Charlie", "vote": "+1", "timestamp": "2025-01-02 10:00"},
        ])
        result = create_vote_dict(mentions)
